...
\item Not explained by Aramaic (0.2--0.4\% match), Italian (4.5\% match),
  or Judeo-Italian conventions (5.0\% match)
\end{itemize}
...
are the genuine Hebrew signal. Restricting the lexicon to the 211
DictaLM-confirmed forms yields a match rate of $25.2\%$ against a
random-string baseline of approximately $1.1\%$ --- a real-to-random
ratio of $\sim$24$\times$, compared to $2.3\times$ for the full honest
lexicon. The signal is thus highly concentrated in approximately 200
high-frequency Hebrew roots.
...
(homophonic cipher, Aramaic, Italian, Judeo-Italian).
...
confirmed as genuine Hebrew words (token-weighted: 56.6\%), yielding a
real-to-random ratio of $\sim$24$\times$ when restricted to confirmed forms.
