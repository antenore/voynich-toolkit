...
language split) are tested and largely rejected. We conclude that the mapping
...
We organize 29 systematic investigations across mapping derivation
...
consonantal morphology. Distinguishing between these possibilities requires
either a domain-specific lexicon test (matching labels against specialized
botanical/astronomical Hebrew terminology) or the identification of
additional cipher structure beyond monoalphabetic substitution.
